"""Train a tuned LightGBM liquidity demand model."""
...
def estimator_and_params():
    """Return LightGBM estimator if installed, otherwise sklearn fallback with compatible tuning."""
...
def main(data_path: str, n_iter: int = 10) -> dict[str, float]:
    """Train LightGBMRegressor or fallback estimator and return test metrics."""
    estimator, params = estimator_and_params()
    return train_tree_regressor(load_feature_data(data_path), estimator, params, "lightgbm", n_iter=n_iter)
